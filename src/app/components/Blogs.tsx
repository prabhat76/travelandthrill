    ...
    <section id="blogs" className="py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-500">No published blogs yet.</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogs.map((blog) => (
              <article key={blog.id} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
